...
export class AdministratorService {
  ...
  getAdministratorById(id: number) {
  ...
  getAdministratorByUsernameAndPassword(username: string, password: string) {
    const administrator = this.administrators.find(
      (ad) => {
  ...
  getAdministratorByUsernameAndPasswordFromDB(username: string, password: string) {
    return this.http.get<Administrator>(this.url + '/getByUsernameAndPassword/' + username + '/' + password);
  }
